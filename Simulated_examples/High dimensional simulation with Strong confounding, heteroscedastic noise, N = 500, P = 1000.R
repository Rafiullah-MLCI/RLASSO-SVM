######################################
# RLASO_SVM High-dimensional simulation with Strong confounding, heteroscedastic noise#
######################################
...
### INFO
N =500
P = 1000  # We tried P = 1000 covariates to see how the problem degenerate
B = 500
